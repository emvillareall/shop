        ...
        <div class="card-body space-y-3">
                    ...
                    <table class="table">
                        ...
                        @foreach($apartados as $ap)
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('ventas.abonos.store', $ap->id) }}" class="d-flex align-items-center gap-2 flex-wrap">
                                        @csrf
                                        <input
                                            type="number"
                                            name="monto"
                                        ...
                                        <a href="{{ route('ventas.index') }}" class="btn btn-sm btn-outline-secondary">Ver</a>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
            ...
            @else
                <div class="rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 py-3 text-sm text-slate-600">
                    No hay apartados pendientes por ahora.
                </div>
            @endif
        </div>
    </div>
