                            ...
                            <table class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
										...
										<th>Nombre Tienda</th>
										<th>Nombres Dueno Tienda</th>
										<th>Apellidos Dueno Tienda</th>
										<th>Cedula Dueno Tienda</th>
										<th>Telefono Dueno Tienda</th>
										<th>Direccion Dueno Tienda</th>
										<th>Email Dueno Tienda</th>
                                ...
                                <tbody>
                                    @foreach ($tiendas as $tienda)
                                        <tr>
											...
											<td>{{ $tienda->nombres_dueno_tienda }}</td>
											<td>{{ $tienda->apellidos_dueno_tienda }}</td>
											<td>{{ $tienda->cedula_dueno_tienda }}</td>
											<td>{{ $tienda->telefono_dueno_tienda }}</td>
											<td>{{ $tienda->direccion_dueno_tienda }}</td>
											<td>{{ $tienda->email_dueno_tienda }}</td>
