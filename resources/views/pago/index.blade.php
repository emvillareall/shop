    ...
    <div class="space-y-4">
        ...
        <div class="card">
            <div class="card-header">
                <span class="text-base font-semibold">Revisión de pagos</span>
            </div>
            <div class="card-body">
                        ...
                        @forelse($pagos as $pago)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @php $providerConfirmed = (bool) data_get((array)($pago->metadata ?? []), 'provider_confirmed', false); @endphp
                                    @if(in_array($pago->metodo, ['paypal', 'payphone']))
