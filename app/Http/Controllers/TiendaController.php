...
class TiendaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'nombres_dueno_tienda' => 'required|string|max:120',
            'apellidos_dueno_tienda' => 'required|string|max:120',
            'cedula_dueno_tienda' => 'required|string|max:40',
            'telefono_dueno_tienda' => 'required|string|max:40',
            'direccion_dueno_tienda' => 'required|string|max:255',
            'email_dueno_tienda' => 'nullable|email|max:120',
            'estado_tienda' => 'nullable',
        ]);
